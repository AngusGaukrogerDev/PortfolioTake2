...
namespace PortfolioTake2.Controllers
{
    public class FlashcardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,EnglishWord,SpanishWord,ImagePromptLink,VideoPromptLink,CardLevel,NumberOfReviews,LastReviewTimestamp")] Flashcard flashcard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,EnglishWord,SpanishWord,ImagePromptLink,VideoPromptLink,CardLevel,NumberOfReviews,LastReviewTimestamp")] Flashcard flashcard)
        {
            if (id != flashcard.ID)
            {
                return NotFound();
